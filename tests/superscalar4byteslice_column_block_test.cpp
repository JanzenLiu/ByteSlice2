...
class Superscalar4ByteSliceColumnBlockTest: public ::testing::Test{
public:
    virtual void SetUp(){
        num_ = kNumTuplesPerBlock*0.8;
        block_ = new Superscalar4ByteSliceColumnBlock<20>(num_);
...
protected:
    Superscalar4ByteSliceColumnBlock<20>* block_;
    size_t num_;
};

TEST_F(Superscalar4ByteSliceColumnBlockTest, DISABLED_SerDeser){
    ...
    ColumnBlock* block2 = new Superscalar4ByteSliceColumnBlock<20>(num_);
...
TEST_F(Superscalar4ByteSliceColumnBlockTest, BulkLoadAndGetTuple){
    for(size_t i=0; i<num_; i++){
...
/*
TEST_F(Superscalar4ByteSliceColumnBlockTest, ScanWithByteMask){
...
TEST_F(Superscalar4ByteSliceColumnBlockTest, ScanLiteral){
...
TEST_F(Superscalar4ByteSliceColumnBlockTest, ScanOtherBlock){
    BitVectorBlock* bvblock = new BitVectorBlock(num_);
    Superscalar4ByteSliceColumnBlock<20>* block2 = new Superscalar4ByteSliceColumnBlock<20>(num_);
