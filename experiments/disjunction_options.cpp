...
int main(int argc, char* argv[]){
    ...
    size_t repeat = 20;
    const char* filename = "disjunction_options.data";
    std::ofstream of;
        ...
        switch(c){
            ...
            case 'c':
                if(0 == strcmp(optarg, "naive"))
                    ...
                    std::cerr << "Unknown disjunction option: " << optarg << std::endl;
                    exit(0);
                }
                break;
        }
    ...
    std::vector<double> selectivity_vec = {0.999, 0.995, 0.99, 0.98, 0.95, 0.9, 0.5, 0.1};
