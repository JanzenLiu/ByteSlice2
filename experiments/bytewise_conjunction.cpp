...
int main(){
    ...
    std::cout << "Byte#0: " << std::bitset<64>(reinterpret_cast<WordUnit>(column1->GetBlock(0)->GetAvxUnit(0, 0))) << std::endl;
    std::cout << "Byte#1: " << std::bitset<64>(reinterpret_cast<WordUnit>(column1->GetBlock(0)->GetAvxUnit(0, 1))) << std::endl;
